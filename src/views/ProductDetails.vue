        ...
        <div v-for="product in $store.state.products" :key="product.id">
            <div v-if="product.id == $route.params.id">
                <div class="row">
                    ...
                    <div
                        class="col-md-7 col-sm-6 fs-5 d-flex flex-column justify-content-between align-items-start mb-md-0 mb-5 px-4">
                        <div class="mt-4 mt-md-0">
                            <h2 class="mb-4">{{product.title}}</h2>
                            <p class="my-2">Categoria: <span class="text-capitalize">{{product.category}}</span></p>
                            <p class="my-2">
                                Nota:
                            ...
                            <p class="mt-3 fs-6">
                                <strong class="fs-4">Descrição</strong>
                                <br />
